...
### DietPi Banner {: id="dietpi-banner" }

Enables the configuration of the initial banner, displayed on logon.
Run `dietpi-banner`.

![DietPi-Banner](assets/images/dietpi-banner_config.jpg){: width="643" height="338" loading="lazy"}
...
![DietPi-Banner](assets/images/dietpi-banner.jpg){: width="636" height="359" loading="lazy"}
