...
=== "Mount network drive"
    ...
    !!! info "Mounting a Samba shared folder"
        In case of a Samba mount do not use a leading `/` in the dialog entering the file servers shared folder name (e.g. enter `public/music` instead of `/public/music`).
