...
Many thanks to @nonnorm for implementing this software option: MichaIng/DietPi#3828
...
Many thanks to @nonnorm for implementing this software option: MichaIng/DietPi#3921.
...
Many thanks to @nonnorm for implementing this software option: MichaIng/DietPi#3872
...
- **Enable automated APT package update checks and even upgrade them on a daily bases**. By setting the new `dietpi.txt` setting
    ...
    Many thanks to @nonnorm for implementing this feature: <https://github.com/MichaIng/DietPi/pull/3899>
...
- **[DietPi-CloudShell](../software/system_stats.md#dietpi-cloudshell)** :octicons-arrow-right-16: Resolved an issue where scene selection failed with a syntax error. Many thanks to @nonnorm for reporting this issue: <https://github.com/MichaIng/DietPi/issues/3880>
