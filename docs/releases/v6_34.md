...
**[Tor Relay - Become part of the Tor Project](../software/advanced_networking.md#tor-hotspot)**
...
For more details check the [documentation page](../software/advanced_networking.md#tor-hotspot).
