...
- [**DietPi-Dashboard**](../software/system_stats.md#dietpi-dashboard)
    We are proud to announce official DietPi Web interface for monitoring and managing your DietPi system using your web browser :octicons-heart-16:! You can see various statistics, and even run commands in the  console embedded in the web page! Thanks to the great work of @nonnorm!
