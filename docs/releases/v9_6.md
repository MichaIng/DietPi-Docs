...
- [**DietPi-Software**](../dietpi_tools/software_installation.md#dietpi-software) | [**soju**](../software/social.md#soju) :octicons-arrow-right-16: New software package. Thanks to @subnut for implementing this software option: <https://github.com/MichaIng/DietPi/pull/7124>
...
- [**DietPi-Tools**](../dietpi_tools.md) | [**DietPi-Banner**](../dietpi_tools/system_configuration.md#dietpi-banner) :octicons-arrow-right-16: Resolved an issue where incorrect RAM usage was printed with German and potentially other locales. Many thanks to @jwgn for reporting this issue: <https://github.com/MichaIng/DietPi/issues/7107>
