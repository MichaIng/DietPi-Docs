...
- [DietPi-Backup](../dietpi_tools.md#dietpi-backup-backuprestore) :octicons-arrow-right-16: A new feature has been added which allows to automatically restore a dietpi-backup on first boot.
    ...
    The restore runs after the initial update, hence works with older images as well and can be done via SSH connection. Credits go to @nonnorm for implementing this feature: <https://github.com/MichaIng/DietPi/pull/4112>.
