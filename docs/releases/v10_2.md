...
- [**DietPi-Software**](../dietpi_tools/software_installation.md#dietpi-software) | **uv** :octicons-arrow-right-16: This extremely fast Python package and project manager, written in Rust, has been added as a standalone software option (ID 217).
