...
- [**DietPi-Config**](../../dietpi_tools/#dietpi-configuration) enhancements :octicons-arrow-right-16:
    ...
    !!! hint ""
        ...
        - Added a **safe overclocking profile for RPi 3+ models**! Many thanks to [@lone](https://dietpi.com/forum/u/lone){: class="nospellcheck"} for doing long-term stability tests and reporting back the result. See the full conversation.
