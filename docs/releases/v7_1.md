...
- [**IPFS Node**](../software/distributed_projects.md#ipfs-node)
    ...
    Many thanks to @nonnorm for implementing this software option: <https://github.com/MichaIng/DietPi/issues/4232>
...
- [**DietPi-VPN**](../dietpi_tools.md#dietpi-vpn)
    ...
    Many thanks to @nonnorm for doing this major rework - see <https://github.com/MichaIng/DietPi/pull/4180>.
