...
- [**DietPi-Software**](../dietpi_tools/software_installation.md#dietpi-software) | [**Docker Compose**](../software/system_stats.md#docker-compose) :octicons-arrow-right-16: Resolved an issue where installing and uninstalling Docker Compose could have failed if pip was installed without the `distutils` module. Many thanks to @bccarbone for reporting this issue: <https://github.com/MichaIng/DietPi/issues/6153>
