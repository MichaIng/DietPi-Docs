...
- [DietPi-LetsEncrypt](../dietpi_tools.md#dietpi-letsencrypt) :octicons-arrow-right-16: Resolved an issue where the script failed when ownCloud or [Nextcloud](../software/cloud.md#nextcloud) were installed. Many thanks to @billouetaudrey for reporting this issue: <https://github.com/MichaIng/DietPi/issues/4752>
