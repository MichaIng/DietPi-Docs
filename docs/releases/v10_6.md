...
- [**Orange Pi 4 Pro, Orange Pi Zero 3W**](../hardware.md#orange-pi-series) :octicons-arrow-right-16: Support and images for these new SBCs with Allwinner A733 SoC have been added. Mainline Linux support for this SoC is still outstanding, hence Xunlongs Linux 6.6 and U-Boot vendor sources are used.
