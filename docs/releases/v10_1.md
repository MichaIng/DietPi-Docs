...
- [**DietPi-Software**](../dietpi_tools/software_installation.md#dietpi-software) | [**Python 3**](../software/programming.md#python-3) :octicons-arrow-right-16: All Python software options make now use of `venvs`, instead of being installed to the system site `/usr/local/lib/python3.*/dist-packages`. Recent `pip` has increasing issues managing modules there on distros which have own Python module packages. Modern setups almost require isolated environments like `venv`.  
