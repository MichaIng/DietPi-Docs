...
![NanoPi Zero2 DietPi-Banner screenshot](../assets/images/dietpi-release-v10_1.webp "DietPi-Banner screen output")

!!! cite "DietPi-Banner output on NanopPi Zero2 screenshot by @StephanStS"
