...
- **DietPi-Software** | **Pydio** :octicons-arrow-right-16: Resolved an issue where the data directory was not writeable. Many thanks @holocronology for reporting this issue: <https://github.com/MichaIng/DietPi/issues/5274>
