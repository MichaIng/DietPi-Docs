...
- [**DietPi-CloudShell**](../../software/system_stats/#dietpi-cloudshell) | [**Pi-hole**](../../software/dns_servers/#pi-hole) :octicons-arrow-right-16: Fix stats with recent Pi-hole version as the port file is not used anymore. Many thanks to @oradke for reporting this issue: <https://github.com/MichaIng/DietPi/issues/5810>
