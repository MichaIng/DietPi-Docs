...
![HomeBox logo](../assets/images/dietpi-software-cloud-homebox.svg){: width="150" height="150" loading="lazy"}
...
=== "HTTPS access via reverse proxy"
    ...
    **Requirements**
    ...
    - A webserver installed via `dietpi-software` (Apache, Nginx or Lighttpd)
