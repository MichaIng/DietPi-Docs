...
- The [server side](https://virtualhere.com/content/usb-servers): This software part is installed witin this DietPi software package. It serves your USB device over the network
