...
- The [server side](https://virtualhere.com/content/usb-servers): This software part is installed within this DietPi software package. It serves your USB device over the network
