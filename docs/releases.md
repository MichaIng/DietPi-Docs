...
- DietPi-Software | Home Assistant :octicons-arrow-right-16: The Python version compiled with Home Assistant has been bumped to v3.9.7, which resolves and issue with installs on 32-bit ARM systems. Many thanks to @Przemek for reporting this issue: <https://github.com/MichaIng/DietPi/issues/4372#issuecomment-936656595>
